...
// Class to hold fake keys data copied from:
// https://github.com/spring-projects/spring-security/blob/6.1.x/oauth2/oauth2-jose/src/test/java/org/springframework/security/oauth2/jose/TestKeys.java
